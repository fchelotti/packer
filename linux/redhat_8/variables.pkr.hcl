...
variable "rhsm_password" {
  ...
  default     = "${env("rhsm_password")}"
}

variable "vsphere_endpoint" {
  type        = string
  description = "The fully qualified domain name or IP address of the vCenter Server instance."
  default     = "[informe a url do vcenter]"
}
...
variable "vsphere_datastore" {
  ...
  default     = "CMB-DS-NODMZ-TN-3215-7F04"
}

variable "vsphere_network" {
  type        = string
  description = "The name of the target vSphere network segment."
  default     = "CMB-DMZ-MGMT-3071"
  // default     = "CMB-DMZ-DATA-3061"
}

variable "vsphere_folder" {
  type        = string
  description = "The name of the target vSphere cluster."
  default     = "PALANCAS_Packer"
}
...
variable "iso_checksum_value" {
  ...
  default     = "8cb0dfacc94b789933253d5583a2fb7afce26d38d75be7c204975fe20b7bdf71"
}
