...
# network  --bootproto=static --device=ens192 --ip=10.106.245.182 --netmask=255.255.255.0 --gateway=10.106.245.10 --nameserver=10.104.3.21 --activate --hostname redhat8-linux
network  --bootproto=static --ip=10.106.245.182 --netmask=255.255.255.0 --hostname redhat8-linux
# network  --bootproto=static --device=ens192 --ip=10.104.244.166 --netmask=255.255.255.0 --nameserver=10.104.3.21 --activate --hostname redhat8-linux
...
user --name="admin" --password="$2b$10$U3zX33aMceDM9G82vl/Nwem/.gfQOu1VW8jz3fNrtb/kDp9BtiIGa" --iscrypted --groups=wheel
...
nmcli con mod ens192 ipv4.addresses 10.106.245.182/24
nmcli con mod ens192 ipv4.method manual
nmcli con mod ens192 ipv4.dns "10.104.3.21"
nmcli con up ens192
nmcli connection modify "System ens192" +ipv4.routes "0.0.0.0/0 10.104.244.1"
nmcli connection modify "System ens192" +ipv4.routes "10.0.0.0/8 10.104.244.254"
nmcli connection modify "System ens192" +ipv4.routes "10.106.255.192/32 10.104.244.254"
nmcli connection modify "System ens192" +ipv4.routes "172.16.0.0/16 10.104.244.254"
nmcli connection modify "System ens192" +ipv4.routes "192.168.0.0/16 10.104.244.254"
%end
...
touch /etc/cloud/cloud-init.disabled
echo "10.105.42.130  lcm001001-017.net lcm001001-017" >> /etc/hosts
