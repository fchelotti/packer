...
network  --bootproto=static --ip=10.106.245.182 --netmask=255.255.255.0 --gateway=10.106.245.10 --nameserver=10.104.3.21 --hostname centos-linux-8
#network  --bootproto=static --ip=192.168.200.210 --netmask=255.255.252.0 --gateway=192.168.200.1 --nameserver=10.104.3.21 --hostname centos-linux-8
#network  --bootproto=static --ip=192.168.200.182 --netmask=255.255.252.0 --gateway=192.168.200.1 --nameserver=10.104.3.21 --hostname centos-linux-8
...
user --name="admin" --password="Admin@2023" --groups=wheel
